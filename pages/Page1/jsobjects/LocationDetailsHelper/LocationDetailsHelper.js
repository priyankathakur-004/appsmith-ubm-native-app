export default {
	...
	getChartConfig() {
		...
		var monthColors = [
			'#60a5fa','#3b82f6','#bef264','#1e3a8a','#22c55e','#166534',
			'#1e40af','#9ca3af','#67e8f9','#f9a8d4','#2dd4bf','#64748b',
			'#f472b6','#fbbf24','#a78bfa','#fb923c','#34d399','#e879f9'
		];
		...
		return {
			...
			grid: { left: 80, right: 180, top: 20, bottom: 80 },
			xAxis: {
				type: 'value',
				name: xLabel,
				nameLocation: 'middle',
